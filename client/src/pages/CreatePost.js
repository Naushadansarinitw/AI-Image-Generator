...
const CreatePost = () => {
  ...
  const handleSubmit = async(e) => {
      ...
      if(form.prompt && form.photo){
        console.log("hellO Inside the form ");
        setLoading(true);
  ...
  return (
    <section className='max-w-7xl mx-auto' >
        ...
        <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
            ...
            <div className="relative bg-gray-50 border border-grey-300 text-grey-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center mt-7">
              {
                form.photo ? (
